...
class Server(object):
    def __init__(self, writer, model_config={}, global_config={}, data_config={}, init_config={}, fed_config={}, optim_config={}, cl_config={}):
        self.clients = None
        self._round = 0
        self.writer = writer
        ...
        self.base_lr = optim_config["lr"]  # keep the undecayed base LR (paper: eta=0.05, decay=0.998/round)
        self.lr_decay = 0.998
    ...
    def train_federated_model(self):
        ...
        # decay the learning rate per communication round (paper: eta * 0.998^round)
        self.optim_config["lr"] = self.base_lr * (self.lr_decay ** self._round)
