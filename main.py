...
if __name__ == "__main__":
    ...
    central_server = Server(writer, model_config, global_config, data_config, init_config, fed_config, optim_config, cl_config)
    ...
    with open(os.path.join(log_config["log_path"], f"result_{os.path.basename(os.path.normpath(log_config['log_path']))}.pkl"), "wb") as f:
